...
[![CI](https://github.com/marlonbarreto-git/mcp-server-starter/actions/workflows/ci.yml/badge.svg)](https://github.com/marlonbarreto-git/mcp-server-starter/actions/workflows/ci.yml)
